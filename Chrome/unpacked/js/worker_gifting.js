...
//	worker.addAction({worker : 'gifting', priority : -400, description : 'Gifting'});
	
//	worker.addAction({worker : 'gifting', priority : -900, description : 'Checking Gifts', functionName : 'ajaxGiftCheck'});
    ...
    gifting = {
		...
		ajaxGiftCheck: function () {
			try {
				...
				con.error("ERROR in AjaxGiftCheck: " + err.stack);
				return false;
			}
		},
		...
		worker: function () {
			try {
				...
				con.error("ERROR in autoGift: " + err.stack);
				return false;
			}
		},
        ...
        load: function (type) {
            try {
                ...
                con.error("ERROR in gifting.load: " + err.stack);
                return false;
            }
        },
        ...
        save: function (type, src) {
            try {
                ...
                con.error("ERROR in gifting.save: " + err.stack);
                return false;
            }
        },
        ...
        clear: function (type) {
            try {
                ...
                con.error("ERROR in gifting.clear: " + err.stack);
                return false;
            }
        },
        ...
        init: function () {
            try {
                ...
                con.error("ERROR in gifting.init: " + err.stack);
                return undefined;
            }
        },
        ...
        ajaxGiftCheck: function () {
            try {
                ...
                con.error("ERROR in gifting.ajaxGiftCheck: " + err.stack);
                return false;
            }
        },
        ...
        selectGift: function (giftChoice) {
            try {
                ...
                con.error("ERROR in gifting.selectGift: " + err.stack);
                return false;
            }
        },
        ...
        run: function () {
            try {
                ...
                con.error("ERROR in gifting.run: " + err.stack);
                return false;
            }
        },
        ...
        accept: function () {
            try {
                ...
                con.error("ERROR in gifting.accept: " + err.stack);
                return undefined;
            }
        },
        ...
        loadCurrent: function () {
            try {
                ...
                con.error("ERROR in gifting.loadCurrent: " + err.stack);
                return false;
            }
        },
        ...
        getCurrent: function () {
            try {
                ...
                con.error("ERROR in gifting.getCurrent: " + err.stack);
                return undefined;
            }
        },
        ...
        setCurrent: function (record, clear, src) {
            try {
                ...
                con.error("ERROR in gifting.setCurrent: " + err.stack);
                return undefined;
            }
        },
        ...
        clearCurrent: function (clearState) {
            try {
                ...
                con.error("ERROR in gifting.clearCurrent: " + err.stack);
                return undefined;
            }
        },
        ...
        collecting: function () {
            try {
                ...
                con.error("ERROR in gifting.collecting: " + err.stack);
                return undefined;
            }
        },
...
//                    caap.visitUrl(caap.domain.protocol[caap.domain.ptype] + caap.domain.url[0] + "/index.php?bm=1&ref=bookmarks&count=0");
                ...
                con.error("ERROR in gifting.collect: " + err.stack);
                return false;
            }
        },
        ...
        collected: function (force) {
            try {
                ...
                con.error("ERROR in gifting.collected: " + err.stack);
                return false;
            }
        },
        ...
        popCheck: function (type) {
            try {
                ...
                */
                ...
                con.error("ERROR in gifting.popCheck: " + err.stack);
                return undefined;
            }
        },
        ...
        menu: function () {
            try {
                ...
                */
                ...
                con.error("ERROR in gifting.menu: " + err.stack);
                return '';
            }
        },
        ...
        gifts: {
            ...
            getItem: function (name) {
                try {
                    ...
                    con.error("ERROR in gifting.gifts.getItem: " + err.stack);
                    return undefined;
                }
            },
            ...
            getImg: function (name) {
                try {
                    ...
                    con.error("ERROR in gifting.gifts.getImg: " + err.stack);
                    return undefined;
                }
            },
            ...
            populate: function () {
                try {
                    ...
                    con.error("ERROR in gifting.gifts.populate: " + err.stack);
                    return undefined;
                }
            },
            ...
            list: function () {
                try {
                    ...
                    con.error("ERROR in gifting.gifts.list: " + err.stack);
                    return undefined;
                }
            },
            ...
            random: function () {
                try {
                    ...
                    con.error("ERROR in gifting.gifts.random: " + err.stack);
                    return undefined;
                }
            },
            ...
            length: function () {
                try {
                    ...
                    con.error("ERROR in gifting.gifts.length: " + err.stack);
                    return undefined;
                }
            }
        },
        ...
        queue: {
            ...
            fix: function () {
                try {
                    ...
                    con.error("ERROR in gifting.queue.fix: " + err.stack);
                    return undefined;
                }
            },
            ...
            length: function () {
                try {
                    ...
                    con.error("ERROR in gifting.queue.length: " + err.stack);
                    return undefined;
                }
            },
            ...
            getIds: function () {
                try {
                    ...
                    con.error("ERROR in gifting.queue.getIds: " + err.stack);
                    return undefined;
                }
            },
            ...
            chooseGift: function () {
                try {
                    ...
                    con.error("ERROR in gifting.queue.chooseGift: " + err.stack);
                    return undefined;
                }
            },
            ...
            clickFriend: function (giftingList) {
                try {
                    ...
                    con.error("ERROR in gifting.queue.clickFriend: " + err.stack);
                    return undefined;
                }
            },
...
con.log(1, 'chooseFriend');
                    ...
                    con.error("ERROR in gifting.queue.chooseFriend: " + err.stack);
                    return undefined;
                }
            },
            ...
            sentGifts: function (msg) {
                try {
                    ...
                    con.error("ERROR in gifting.queue.sentGifts: " + err.stack);
                    gifting.messageSent = false;
                    return false;
                }
            },
            ...
            checkSent: function (event) {
                try {
                    ...
                    con.error("ERROR in gifting.queue.checkSent: " + err.stack);
                }
            },
            ...
            setCheckedIds: function (idArray) {
                try {
                    ...
                    con.error("ERROR in gifting.queue.setCheckedIds: " + err.stack);
                    gifting.messageSent = false;
                    return false;
                }
            },
            ...
            sent: function () {
                try {
                    ...
                    con.error("ERROR in gifting.queue.sent: " + err.stack);
                    return undefined;
                }
            },
            ...
            dashboard: function () {
                try {
                    ...
                    con.error("ERROR in gifting.queue.dashboard: " + err.stack);
                    return false;
                }
            }
        },
        ...
        history: {
            ...
            fix: function () {
                try {
                    ...
                    con.error("ERROR in gifting.history.fix: " + err.stack);
                    return undefined;
                }
            },
            ...
            getIds: function () {
                try {
                    ...
                    con.error("ERROR in gifting.history.getIds: " + err.stack);
                    return undefined;
                }
            },
            ...
            length: function () {
                try {
                    ...
                    con.error("ERROR in gifting.history.length: " + err.stack);
                    return undefined;
                }
            },
            ...
            dashboard: function () {
                try {
                    ...
                    con.error("ERROR in gifting.history.dashboard: " + err.stack);
                    return false;
                }
            }
        }

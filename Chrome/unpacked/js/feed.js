                ...
                if (config.getItem('DBDisplay', '') === 'Feed' && session.getItem("FeeedDashUpdate", true)) {
                    ...
                    for (i = 0, len = feed.recordsSortable.length; i < len; i += 1) {
                        ...
                        for (pp = 0; pp < values.length; pp += 1) {
                            ...
                            case 'monster':
                                data = {
                                    text: '<span id="caap_feed_' + i + '" title="Clicking this link will take you to the monster" rlink="' +
                                        feed.recordsSortable[i].url + '" mmd5="' + feed.recordsSortable[i].md5 + '" onmouseover="this.style.cursor=\'pointer\';" onmouseout="this.style.cursor=\'default\';">' + value + '</span>',
                                    color: 'blue',
                                    id: '',
                                    title: ''
                                };
                            ...
                            case 'review':
                                row += caap.makeTd({
                                    text: $u.makeTime(value, "d M H:i"),
                                    color: feed.recordsSortable[i].checked ? 'green' : color,
                                    id: '',
                                    title: ''
                                });
                                break;
                            case 'page':
                                row += caap.makeTd({
                                    text: value.hasIndexOf('festival') ? "Festival" : "Standard",
                                    color: feed.recordsSortable[i].checked ? 'green' : color,
                                    id: '',
                                    title: ''
                                });
                            ...
                            case 'life':
                                row += caap.makeTd({
                                    text: value,
                                    color: feed.recordsSortable[i].checked ? (feed.recordsSortable[i].life < 10 ? 'red' : 'green') : color,
                                    id: '',
                                    title: ''
                                });
                                break;
                            case 't2k':
                                row += caap.makeTd({
                                    text: $u.minutes2hours(value),
                                    color: feed.recordsSortable[i].checked ? (feed.recordsSortable[i].t2k < (feed.recordsSortable[i].time[0] + feed.recordsSortable[i].time[1] / 60) ? 'purple' : 'green') : color,
                                    id: '',
                                    title: ''
                                });
                                break;
                            case 'time':
                                row += caap.makeTd({
                                    text: value = value[0] + ":" + value[1].lpad("0", 2),
                                    color: feed.recordsSortable[i].checked ? (feed.recordsSortable[i].time[0] < 2 ? 'red' : 'green') : color,
                                    id: '',
                                    title: ''
                                });
                                break;

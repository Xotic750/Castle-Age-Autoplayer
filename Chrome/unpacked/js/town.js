...
(function() {
    ...
    town.types = ['soldiers', 'item', 'magic'];

    town.soldiershbest = 3;

    town.itemhbest = 2;

    town.magichbest = 2;

    town.load = function(type) {
        try {
    ...
    town.getCount = function(name, image) {
        try {
            var it1 = 0,
                it2 = 0,
                tempIt1 = -1,
    ...
    town.bestStuffDialog = {};

    town.bestStuff = function(reportType, stance, size, displayRef) {
    ...
    town.dashboard = function() {
        try {
            /*-------------------------------------------------------------------------------------\
                ...
                \-------------------------------------------------------------------------------------*/
            if ((config.getItem('DBDisplay', '') === 'Soldiers Stats' && session.getItem("SoldiersDashUpdate", true)) || (config.getItem('DBDisplay', '') === 'Item Stats' && session.getItem("ItemDashUpdate", true)) ||
                    (config.getItem('DBDisplay', '') === 'Magic Stats' && session.getItem("MagicDashUpdate", true))) {

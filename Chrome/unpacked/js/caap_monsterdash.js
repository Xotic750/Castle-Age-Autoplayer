...
caap.makeTh = function(header, style) {
	try {
		var type = " data-type='bestcolor'", html = '<th';
...
caap.makeTd = function(data, style) {
	try {
		var type = " data-type='bestcolor'", html = '<td';
...
caap.refreshMonstersListener = function(e) {
	monster.flagFullReview();
};
caap.refreshGuildMonstersListener = function(e) {
...
caap.liveFeedButtonListener = function(e) {
...
/*jslint sub: true */
caap.fastHealButtonListener = function(e) {

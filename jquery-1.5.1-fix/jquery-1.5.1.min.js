...
b)}return true}});c.fn.extend({data:function(a,b){var d=null;if(typeof a==="undefined"){if(this.length){d=c.data(this[0]);if(this[0].nodeType===1)for(var e=this[0].attributes,f,h=0,j=e.length;h<j;h++){f=e[h].name;if(f.indexOf("data-")===0){f=f.substr(5);za(this[0],f,d[f])}}}return d}else if(typeof a==="object")return this.each(function(){c.data(this,a)});var p=a.split(".");p[1]=p[1]?"."+p[1]:"";if(b===z){d=this.triggerHandler("getData"+p[1]+"!",[p[0]]);if(d===z&&this.length){d=c.data(this[0],a);d=
za(this[0],a,d)}return d===z&&p[1]?this.data(p[0]):d}else return this.each(function(){var n=c(this),l=[p[0],b];n.triggerHandler("setData"+p[1]+"!",l);c.data(this,a,b);n.triggerHandler("changeData"+p[1]+"!",l)})},removeData:function(a){return this.each(function(){c.removeData(this,a)})}});c.extend({queue:function(a,b,d){if(a){b=(b||"fx")+"queue";var e=c._data(a,b);if(!d)return e||[];if(!e||c.isArray(d))e=c._data(a,b,c.makeArray(d));else e.push(d);return e}},dequeue:function(a,b){b=b||"fx";var d=c.queue(a,
b),e=d.shift();if(e==="inprogress")e=d.shift();if(e){b==="fx"&&d.unshift("inprogress");e.call(a,function(){c.dequeue(a,b)})}d.length||c.removeData(a,b+"queue",true)}});c.fn.extend({queue:function(a,b){if(typeof a!=="string"){b=a;a="fx"}if(b===z)return c.queue(this[0],a);return this.each(function(){var d=c.queue(this,a,b);a==="fx"&&d[0]!=="inprogress"&&c.dequeue(this,a)})},dequeue:function(a){return this.each(function(){c.dequeue(this,a)})},delay:function(a,b){a=c.fx?c.fx.speeds[a]||a:a;b=b||"fx";
return this.queue(b,function(){var d=this;setTimeout(function(){c.dequeue(d,b)},a)})},clearQueue:function(a){return this.queue(a||"fx",[])}});var Ka=/[\n\t\r]/g,va=/\s+/,lb=/\r/g,mb=/^(?:href|src|style)$/,nb=/^(?:button|input)$/i,ob=/^(?:button|input|object|select|textarea)$/i,pb=/^a(?:rea)?$/i,La=/^(?:radio|checkbox)$/i;c.props={"for":"htmlFor","class":"className",readonly:"readOnly",maxlength:"maxLength",cellspacing:"cellSpacing",rowspan:"rowSpan",colspan:"colSpan",tabindex:"tabIndex",usemap:"useMap",
frameborder:"frameBorder"};c.fn.extend({attr:function(a,b){return c.access(this,a,b,true,c.attr)},removeAttr:function(a){return this.each(function(){c.attr(this,a,"");this.nodeType===1&&this.removeAttribute(a)})},addClass:function(a){if(c.isFunction(a))return this.each(function(l){var t=c(this);t.addClass(a.call(this,l,t.attr("class")))});if(a&&typeof a==="string")for(var b=(a||"").split(va),d=0,e=this.length;d<e;d++){var f=this[d];if(f.nodeType===1)if(f.className){for(var h=" "+f.className+" ",j=
f.className,p=0,n=b.length;p<n;p++)if(h.indexOf(" "+b[p]+" ")<0)j+=" "+b[p];f.className=c.trim(j)}else f.className=a}return this},removeClass:function(a){if(c.isFunction(a))return this.each(function(n){var l=c(this);l.removeClass(a.call(this,n,l.attr("class")))});if(a&&typeof a==="string"||a===z)for(var b=(a||"").split(va),d=0,e=this.length;d<e;d++){var f=this[d];if(f.nodeType===1&&f.className)if(a){for(var h=(" "+f.className+" ").replace(Ka," "),j=0,p=b.length;j<p;j++)h=h.replace(" "+b[j]+" "," ");
f.className=c.trim(h)}else f.className=""}return this},toggleClass:function(a,b){var d=typeof a,e=typeof b==="boolean";if(c.isFunction(a))return this.each(function(f){var h=c(this);h.toggleClass(a.call(this,f,h.attr("class"),b),b)});return this.each(function(){if(d==="string")for(var f,h=0,j=c(this),p=b,n=a.split(va);f=n[h++];){p=e?p:!j.hasClass(f);j[p?"addClass":"removeClass"](f)}else if(d==="undefined"||d==="boolean"){this.className&&c._data(this,"__className__",this.className);this.className=this.className||
a===false?"":c._data(this,"__className__")||""}})},hasClass:function(a){a=" "+a+" ";for(var b=0,d=this.length;b<d;b++)if((" "+this[b].className+" ").replace(Ka," ").indexOf(a)>-1)return true;return false},val:function(a){if(!arguments.length){var b=this[0];if(b){if(c.nodeName(b,"option")){var d=b.attributes.value;return!d||d.specified?b.value:b.text}if(c.nodeName(b,"select")){d=b.selectedIndex;var e=[],f=b.options;b=b.type==="select-one";if(d<0)return null;for(var h=b?d:0,j=b?d+1:f.length;h<j;h++){var p=
f[h];if(p.selected&&(c.support.optDisabled?!p.disabled:p.getAttribute("disabled")===null)&&(!p.parentNode.disabled||!c.nodeName(p.parentNode,"optgroup"))){a=c(p).val();if(b)return a;e.push(a)}}if(b&&!e.length&&f.length)return c(f[d]).val();return e}if(La.test(b.type)&&!c.support.checkOn)return b.getAttribute("value")===null?"on":b.value;return(b.value||"").replace(lb,"")}return z}var n=c.isFunction(a);return this.each(function(l){var t=c(this),A=a;if(this.nodeType===1){if(n)A=a.call(this,l,t.val());
if(A==null)A="";else if(typeof A==="number")A+="";else if(c.isArray(A))A=c.map(A,function(D){return D==null?"":D+""});if(c.isArray(A)&&La.test(this.type))this.checked=c.inArray(t.val(),A)>=0;else if(c.nodeName(this,"select")){var F=c.makeArray(A);c("option",this).each(function(){this.selected=c.inArray(c(this).val(),F)>=0});if(!F.length)this.selectedIndex=-1}else this.value=A}})}});c.extend({attrFn:{val:true,css:true,html:true,text:true,data:true,width:true,height:true,offset:true},attr:function(a,
...
a.getAttributeNode("tabIndex"))&&b.specified?b.value:ob.test(a.nodeName)||pb.test(a.nodeName)&&a.href?0:z;return a[b]}if(!c.support.style&&e&&b==="style"){if(f)a.style.cssText=""+d;return a.style.cssText}f&&a.setAttribute(b,""+d);if(!a.attributes[b]&&a.hasAttribute&&!a.hasAttribute(b))return z;a=!c.support.hrefNormalized&&e&&h?a.getAttribute(b,2):a.getAttribute(b);return a===null?z:a}if(f)a[b]=d;return a[b]}});var ia=/\.(.*)$/,wa=/^(?:textarea|input|select)$/i,db=/\./g,eb=/ /g,qb=/[^\w\s.|`]/g,rb=
function(a){return a.replace(qb,"\\$&")};c.event={add:function(a,b,d,e){if(!(a.nodeType===3||a.nodeType===8)){try{if(c.isWindow(a)&&a!==I&&!a.frameElement)a=I}catch(f){}if(d===false)d=$;else if(!d)return;var h,j;if(d.handler){h=d;d=h.handler}if(!d.guid)d.guid=c.guid++;if(j=c._data(a)){var p=j.events,n=j.handle;if(!p)j.events=p={};if(!n)j.handle=n=function(){return typeof c!=="undefined"&&!c.event.triggered?c.event.handle.apply(n.elem,arguments):z};n.elem=a;b=b.split(" ");for(var l,t=0,A;l=b[t++];){j=
h?c.extend({},h):{handler:d,data:e};if(l.indexOf(".")>-1){A=l.split(".");l=A.shift();j.namespace=A.slice(0).sort().join(".")}else{A=[];j.namespace=""}j.type=l;if(!j.guid)j.guid=d.guid;var F=p[l],D=c.event.special[l]||{};if(!F){F=p[l]=[];if(!D.setup||D.setup.call(a,e,A,n)===false)if(a.addEventListener)a.addEventListener(l,n,false);else a.attachEvent&&a.attachEvent("on"+l,n)}if(D.add){D.add.call(a,j);if(!j.handler.guid)j.handler.guid=d.guid}F.push(j);c.event.global[l]=true}a=null}}},global:{},remove:function(a,
b,d,e){if(!(a.nodeType===3||a.nodeType===8)){if(d===false)d=$;var f,h,j=0,p,n,l,t,A,F,D=c.hasData(a)&&c._data(a),G=D&&D.events;if(D&&G){if(b&&b.type){d=b.handler;b=b.type}if(!b||typeof b==="string"&&b.charAt(0)==="."){b=b||"";for(f in G)c.event.remove(a,f+b)}else{for(b=b.split(" ");f=b[j++];){t=f;p=f.indexOf(".")<0;n=[];if(!p){n=f.split(".");f=n.shift();l=RegExp("(^|\\.)"+c.map(n.slice(0).sort(),rb).join("\\.(?:.*\\.)?")+"(\\.|$)")}if(A=G[f])if(d){t=c.event.special[f]||{};for(h=e||0;h<A.length;h++){F=
A[h];if(d.guid===F.guid){if(p||l.test(F.namespace)){e==null&&A.splice(h--,1);t.remove&&t.remove.call(a,F)}if(e!=null)break}}if(A.length===0||e!=null&&A.length===1){if(!t.teardown||t.teardown.call(a,n)===false)c.removeEvent(a,f,D.handle);delete G[f]}}else for(h=0;h<A.length;h++){F=A[h];if(p||l.test(F.namespace)){c.event.remove(a,t,F.handler,h);A.splice(h--,1)}}}if(c.isEmptyObject(G)){if(b=D.handle)b.elem=null;delete D.events;delete D.handle;c.isEmptyObject(D)&&c.removeData(a,z,true)}}}}},trigger:function(a,
b,d,e){var f=a.type||a;if(!e){a=typeof a==="object"?a[c.expando]?a:c.extend(c.Event(f),a):c.Event(f);if(f.indexOf("!")>=0){a.type=f=f.slice(0,-1);a.exclusive=true}if(!d){a.stopPropagation();c.event.global[f]&&c.each(c.cache,function(){var A=this[c.expando];A&&A.events&&A.events[f]&&c.event.trigger(a,b,A.handle.elem)})}if(!d||d.nodeType===3||d.nodeType===8)return z;a.result=z;a.target=d;b=c.makeArray(b);b.unshift(a)}a.currentTarget=d;(e=c._data(d,"handle"))&&e.apply(d,b);e=d.parentNode||d.ownerDocument;
...
a.returnValue===false||a.getPreventDefault&&a.getPreventDefault()?ha:$}else this.type=a;this.timeStamp=c.now();this[c.expando]=true};c.Event.prototype={preventDefault:function(){this.isDefaultPrevented=ha;var a=this.originalEvent;if(a)if(a.preventDefault)a.preventDefault();else a.returnValue=false},stopPropagation:function(){this.isPropagationStopped=ha;var a=this.originalEvent;if(a){a.stopPropagation&&a.stopPropagation();a.cancelBubble=true}},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=
ha;this.stopPropagation()},isDefaultPrevented:$,isPropagationStopped:$,isImmediatePropagationStopped:$};var Ma=function(a){var b=a.relatedTarget;try{if(!(b!==w&&!b.parentNode)){for(;b&&b!==this;)b=b.parentNode;if(b!==this){a.type=a.data;c.event.handle.apply(this,arguments)}}}catch(d){}},Na=function(a){a.type=a.data;c.event.handle.apply(this,arguments)};c.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){c.event.special[a]={setup:function(d){c.event.add(this,b,d&&d.selector?Na:Ma,a)},
teardown:function(d){c.event.remove(this,b,d&&d.selector?Na:Ma)}}});if(!c.support.submitBubbles)c.event.special.submit={setup:function(){if(this.nodeName&&this.nodeName.toLowerCase()!=="form"){c.event.add(this,"click.specialSubmit",function(a){var b=a.target,d=b.type;if((d==="submit"||d==="image")&&c(b).closest("form").length)Aa("submit",this,arguments)});c.event.add(this,"keypress.specialSubmit",function(a){var b=a.target,d=b.type;if((d==="text"||d==="password")&&c(b).closest("form").length&&a.keyCode===
13)Aa("submit",this,arguments)})}else return false},teardown:function(){c.event.remove(this,".specialSubmit")}};if(!c.support.changeBubbles){var fa,Oa=function(a){var b=a.type,d=a.value;if(b==="radio"||b==="checkbox")d=a.checked;else if(b==="select-multiple")d=a.selectedIndex>-1?c.map(a.options,function(e){return e.selected}).join("-"):"";else if(a.nodeName.toLowerCase()==="select")d=a.selectedIndex;return d},ma=function(a,b){var d=a.target,e,f;if(!(!wa.test(d.nodeName)||d.readOnly)){e=c._data(d,
"_change_data");f=Oa(d);if(a.type!=="focusout"||d.type!=="radio")c._data(d,"_change_data",f);if(!(e===z||f===e))if(e!=null||f){a.type="change";a.liveFired=z;c.event.trigger(a,b,d)}}};c.event.special.change={filters:{focusout:ma,beforedeactivate:ma,click:function(a){var b=a.target,d=b.type;if(d==="radio"||d==="checkbox"||b.nodeName.toLowerCase()==="select")ma.call(this,a)},keydown:function(a){var b=a.target,d=b.type;if(a.keyCode===13&&b.nodeName.toLowerCase()!=="textarea"||a.keyCode===32&&(d==="checkbox"||
d==="radio")||d==="select-multiple")ma.call(this,a)},beforeactivate:function(a){a=a.target;c._data(a,"_change_data",Oa(a))}},setup:function(){if(this.type==="file")return false;for(var a in fa)c.event.add(this,a+".specialChange",fa[a]);return wa.test(this.nodeName)},teardown:function(){c.event.remove(this,".specialChange");return wa.test(this.nodeName)}};fa=c.event.special.change.filters;fa.focus=fa.beforeactivate}w.addEventListener&&c.each({focus:"focusin",blur:"focusout"},function(a,b){function d(e){e=
c.event.fix(e);e.type=b;return c.event.handle.call(this,e)}c.event.special[b]={setup:function(){this.addEventListener(a,d,true)},teardown:function(){this.removeEventListener(a,d,true)}}});c.each(["bind","one"],function(a,b){c.fn[b]=function(d,e,f){if(typeof d==="object"){for(var h in d)this[b](h,e,d[h],f);return this}if(c.isFunction(e)||e===false){f=e;e=z}var j=b==="one"?c.proxy(f,function(n){c(this).unbind(n,j);return f.apply(this,arguments)}):f;if(d==="unload"&&b!=="one")this.one(d,e,f);else{h=
0;for(var p=this.length;h<p;h++)c.event.add(this[h],d,j,e)}return this}});c.fn.extend({unbind:function(a,b){if(typeof a==="object"&&!a.preventDefault)for(var d in a)this.unbind(d,a[d]);else{d=0;for(var e=this.length;d<e;d++)c.event.remove(this[d],a,b)}return this},delegate:function(a,b,d,e){return this.live(b,d,e,a)},undelegate:function(a,b,d){return arguments.length===0?this.unbind("live"):this.die(b,null,d,a)},trigger:function(a,b){return this.each(function(){c.event.trigger(a,b,this)})},triggerHandler:function(a,
b){if(this[0]){var d=c.Event(a);d.preventDefault();d.stopPropagation();c.event.trigger(d,b,this[0]);return d.result}},toggle:function(a){for(var b=arguments,d=1;d<b.length;)c.proxy(a,b[d++]);return this.click(c.proxy(a,function(e){var f=(c._data(this,"lastToggle"+a.guid)||0)%d;c._data(this,"lastToggle"+a.guid,f+1);e.preventDefault();return b[f].apply(this,arguments)||false}))},hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)}});var Pa={focus:"focusin",blur:"focusout",mouseenter:"mouseover",
mouseleave:"mouseout"};c.each(["live","die"],function(a,b){c.fn[b]=function(d,e,f,h){var j,p=0,n,l,t=h||this.selector;h=h?this:c(this.context);if(typeof d==="object"&&!d.preventDefault){for(j in d)h[b](j,e,d[j],t);return this}if(c.isFunction(e)){f=e;e=z}for(d=(d||"").split(" ");(j=d[p++])!=null;){n=ia.exec(j);l="";if(n){l=n[0];j=j.replace(ia,"")}if(j==="hover")d.push("mouseenter"+l,"mouseleave"+l);else{n=j;if(j==="focus"||j==="blur"){d.push(Pa[j]+l);j+=l}else j=(Pa[j]||j)+l;if(b==="live"){l=0;for(var A=
h.length;l<A;l++)c.event.add(h[l],"live."+ja(j,t),{data:e,selector:t,handler:f,origType:j,origHandler:f,preType:n})}else h.unbind("live."+ja(j,t),f)}}return this}});c.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".split(" "),function(a,b){c.fn[b]=function(d,e){if(e==null){e=d;d=null}return arguments.length>0?this.bind(b,d,e):this.trigger(b)};if(c.attrFn)c.attrFn[b]=
true});(function(){function a(g,k,q,m,o,s){o=0;for(var y=m.length;o<y;o++){var x=m[o];if(x){var E=false;for(x=x[g];x;){if(x.sizcache===q){E=m[x.sizset];break}if(x.nodeType===1&&!s){x.sizcache=q;x.sizset=o}if(x.nodeName.toLowerCase()===k){E=x;break}x=x[g]}m[o]=E}}}function b(g,k,q,m,o,s){o=0;for(var y=m.length;o<y;o++){var x=m[o];if(x){var E=false;for(x=x[g];x;){if(x.sizcache===q){E=m[x.sizset];break}if(x.nodeType===1){if(!s){x.sizcache=q;x.sizset=o}if(typeof k!=="string"){if(x===k){E=true;break}}else if(l.filter(k,
[x]).length>0){E=x;break}}x=x[g]}m[o]=E}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,e=0,f=Object.prototype.toString,h=false,j=true,p=/\\/g,n=/\W/;[0,0].sort(function(){j=false;return 0});var l=function(g,k,q,m){q=q||[];var o=k=k||w;if(k.nodeType!==1&&k.nodeType!==9)return[];if(!g||typeof g!=="string")return q;var s,y,x,E,P,N=true,L=l.isXML(k),i=[],r=g;do{d.exec("");if(s=d.exec(r)){r=s[3];i.push(s[1]);
if(s[2]){E=s[3];break}}}while(s);if(i.length>1&&A.exec(g))if(i.length===2&&t.relative[i[0]])y=S(i[0]+i[1],k);else for(y=t.relative[i[0]]?[k]:l(i.shift(),k);i.length;){g=i.shift();if(t.relative[g])g+=i.shift();y=S(g,y)}else{if(!m&&i.length>1&&k.nodeType===9&&!L&&t.match.ID.test(i[0])&&!t.match.ID.test(i[i.length-1])){s=l.find(i.shift(),k,L);k=s.expr?l.filter(s.expr,s.set)[0]:s.set[0]}if(k){s=m?{expr:i.pop(),set:G(m)}:l.find(i.pop(),i.length===1&&(i[0]==="~"||i[0]==="+")&&k.parentNode?k.parentNode:
k,L);y=s.expr?l.filter(s.expr,s.set):s.set;if(i.length>0)x=G(y);else N=false;for(;i.length;){s=P=i.pop();if(t.relative[P])s=i.pop();else P="";if(s==null)s=k;t.relative[P](x,s,L)}}else x=[]}x||(x=y);x||l.error(P||g);if(f.call(x)==="[object Array]")if(N)if(k&&k.nodeType===1)for(g=0;x[g]!=null;g++){if(x[g]&&(x[g]===true||x[g].nodeType===1&&l.contains(k,x[g])))q.push(y[g])}else for(g=0;x[g]!=null;g++)x[g]&&x[g].nodeType===1&&q.push(y[g]);else q.push.apply(q,x);else G(x,q);if(E){l(E,o,q,m);l.uniqueSort(q)}return q};
l.uniqueSort=function(g){if(J){h=j;g.sort(J);if(h)for(var k=1;k<g.length;k++)g[k]===g[k-1]&&g.splice(k--,1)}return g};l.matches=function(g,k){return l(g,null,null,k)};l.matchesSelector=function(g,k){return l(k,null,null,[g]).length>0};l.find=function(g,k,q){var m;if(!g)return[];for(var o=0,s=t.order.length;o<s;o++){var y,x=t.order[o];if(y=t.leftMatch[x].exec(g)){var E=y[1];y.splice(1,1);if(E.substr(E.length-1)!=="\\"){y[1]=(y[1]||"").replace(p,"");m=t.find[x](y,k,q);if(m!=null){g=g.replace(t.match[x],
"");break}}}}m||(m=typeof k.getElementsByTagName!=="undefined"?k.getElementsByTagName("*"):[]);return{set:m,expr:g}};l.filter=function(g,k,q,m){for(var o,s,y=g,x=[],E=k,P=k&&k[0]&&l.isXML(k[0]);g&&k.length;){for(var N in t.filter)if((o=t.leftMatch[N].exec(g))!=null&&o[2]){var L,i,r=t.filter[N];i=o[1];s=false;o.splice(1,1);if(i.substr(i.length-1)!=="\\"){if(E===x)x=[];if(t.preFilter[N])if(o=t.preFilter[N](o,E,q,x,m,P)){if(o===true)continue}else s=L=true;if(o)for(var u=0;(i=E[u])!=null;u++)if(i){L=
r(i,o,u,E);var v=m^!!L;if(q&&L!=null)if(v)s=true;else E[u]=false;else if(v){x.push(i);s=true}}if(L!==z){q||(E=x);g=g.replace(t.match[N],"");if(!s)return[];break}}}if(g===y)if(s==null)l.error(g);else break;y=g}return E};l.error=function(g){throw"Syntax error, unrecognized expression: "+g;};var t=l.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,
TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(g){return g.getAttribute("href")},type:function(g){return g.getAttribute("type")}},relative:{"+":function(g,k){var q=
...
"":function(g,k,q){var m,o=e++,s=b;if(typeof k==="string"&&!n.test(k)){m=k=k.toLowerCase();s=a}s("parentNode",k,o,g,m,q)},"~":function(g,k,q){var m,o=e++,s=b;if(typeof k==="string"&&!n.test(k)){m=k=k.toLowerCase();s=a}s("previousSibling",k,o,g,m,q)}},find:{ID:function(g,k,q){if(typeof k.getElementById!=="undefined"&&!q)return(g=k.getElementById(g[1]))&&g.parentNode?[g]:[]},NAME:function(g,k){if(typeof k.getElementsByName!=="undefined"){for(var q=[],m=k.getElementsByName(g[1]),o=0,s=m.length;o<s;o++)m[o].getAttribute("name")===
g[1]&&q.push(m[o]);return q.length===0?null:q}},TAG:function(g,k){if(typeof k.getElementsByTagName!=="undefined")return k.getElementsByTagName(g[1])}},preFilter:{CLASS:function(g,k,q,m,o,s){g=" "+g[1].replace(p,"")+" ";if(s)return g;s=0;for(var y;(y=k[s])!=null;s++)if(y)if(o^(y.className&&(" "+y.className+" ").replace(/[\t\n\r]/g," ").indexOf(g)>=0))q||m.push(y);else if(q)k[s]=false;return false},ID:function(g){return g[1].replace(p,"")},TAG:function(g){return g[1].replace(p,"").toLowerCase()},CHILD:function(g){if(g[1]===
"nth"){g[2]||l.error(g[0]);g[2]=g[2].replace(/^\+|\s*/g,"");var k=/(-?)(\d*)(?:n([+\-]?\d*))?/.exec(g[2]==="even"&&"2n"||g[2]==="odd"&&"2n+1"||!/\D/.test(g[2])&&"0n+"+g[2]||g[2]);g[2]=k[1]+(k[2]||1)-0;g[3]=k[3]-0}else g[2]&&l.error(g[0]);g[0]=e++;return g},ATTR:function(g,k,q,m,o,s){k=g[1]=g[1].replace(p,"");if(!s&&t.attrMap[k])g[1]=t.attrMap[k];g[4]=(g[4]||g[5]||"").replace(p,"");if(g[2]==="~=")g[4]=" "+g[4]+" ";return g},PSEUDO:function(g,k,q,m,o){if(g[1]==="not")if((d.exec(g[3])||"").length>1||
/^\w/.test(g[3]))g[3]=l(g[3],null,null,k);else{g=l.filter(g[3],k,q,true^o);q||m.push.apply(m,g);return false}else if(t.match.POS.test(g[0])||t.match.CHILD.test(g[0]))return true;return g},POS:function(g){g.unshift(true);return g}},filters:{enabled:function(g){return g.disabled===false&&g.type!=="hidden"},disabled:function(g){return g.disabled===true},checked:function(g){return g.checked===true},selected:function(g){return g.selected===true},parent:function(g){return!!g.firstChild},empty:function(g){return!g.firstChild},
has:function(g,k,q){return!!l(q[3],g).length},header:function(g){return/h\d/i.test(g.nodeName)},text:function(g){return"text"===g.getAttribute("type")},radio:function(g){return"radio"===g.type},checkbox:function(g){return"checkbox"===g.type},file:function(g){return"file"===g.type},password:function(g){return"password"===g.type},submit:function(g){return"submit"===g.type},image:function(g){return"image"===g.type},reset:function(g){return"reset"===g.type},button:function(g){return"button"===g.type||
g.nodeName.toLowerCase()==="button"},input:function(g){return/input|select|textarea|button/i.test(g.nodeName)}},setFilters:{first:function(g,k){return k===0},last:function(g,k,q,m){return k===m.length-1},even:function(g,k){return k%2===0},odd:function(g,k){return k%2===1},lt:function(g,k,q){return k<q[3]-0},gt:function(g,k,q){return k>q[3]-0},nth:function(g,k,q){return q[3]-0===k},eq:function(g,k,q){return q[3]-0===k}},filter:{PSEUDO:function(g,k,q,m){var o=k[1],s=t.filters[o];if(s)return s(g,q,k,
m);else if(o==="contains")return(g.textContent||g.innerText||l.getText([g])||"").indexOf(k[3])>=0;else if(o==="not"){k=k[3];q=0;for(m=k.length;q<m;q++)if(k[q]===g)return false;return true}else l.error(o)},CHILD:function(g,k){var q=k[1],m=g;switch(q){case "only":case "first":for(;m=m.previousSibling;)if(m.nodeType===1)return false;if(q==="first")return true;m=g;case "last":for(;m=m.nextSibling;)if(m.nodeType===1)return false;return true;case "nth":q=k[2];var o=k[3];if(q===1&&o===0)return true;var s=
k[0],y=g.parentNode;if(y&&(y.sizcache!==s||!g.nodeIndex)){var x=0;for(m=y.firstChild;m;m=m.nextSibling)if(m.nodeType===1)m.nodeIndex=++x;y.sizcache=s}m=g.nodeIndex-o;return q===0?m===0:m%q===0&&m/q>=0}},ID:function(g,k){return g.nodeType===1&&g.getAttribute("id")===k},TAG:function(g,k){return k==="*"&&g.nodeType===1||g.nodeName.toLowerCase()===k},CLASS:function(g,k){return(" "+(g.className||g.getAttribute("class"))+" ").indexOf(k)>-1},ATTR:function(g,k){var q=k[1];q=t.attrHandle[q]?t.attrHandle[q](g):
g[q]!=null?g[q]:g.getAttribute(q);var m=q+"",o=k[2],s=k[4];return q==null?o==="!=":o==="="?m===s:o==="*="?m.indexOf(s)>=0:o==="~="?(" "+m+" ").indexOf(s)>=0:!s?m&&q!==false:o==="!="?m!==s:o==="^="?m.indexOf(s)===0:o==="$="?m.substr(m.length-s.length)===s:o==="|="?m===s||m.substr(0,s.length+1)===s+"-":false},POS:function(g,k,q,m){var o=t.setFilters[k[2]];if(o)return o(g,q,k,m)}}},A=t.match.POS,F=function(g,k){return"\\"+(k-0+1)},D;for(D in t.match){t.match[D]=RegExp(t.match[D].source+/(?![^\[]*\])(?![^\(]*\))/.source);
t.leftMatch[D]=RegExp(/(^(?:.|\r|\n)*?)/.source+t.match[D].source.replace(/\\(\d+)/g,F))}var G=function(g,k){g=Array.prototype.slice.call(g,0);if(k){k.push.apply(k,g);return k}return g};try{Array.prototype.slice.call(w.documentElement.childNodes,0)}catch(M){G=function(g,k){var q=0,m=k||[];if(f.call(g)==="[object Array]")Array.prototype.push.apply(m,g);else if(typeof g.length==="number")for(var o=g.length;q<o;q++)m.push(g[q]);else for(;g[q];q++)m.push(g[q]);return m}}var J,O;if(w.documentElement.compareDocumentPosition)J=
function(g,k){if(g===k){h=true;return 0}if(!g.compareDocumentPosition||!k.compareDocumentPosition)return g.compareDocumentPosition?-1:1;return g.compareDocumentPosition(k)&4?-1:1};else{J=function(g,k){var q,m,o=[],s=[];q=g.parentNode;m=k.parentNode;var y=q;if(g===k){h=true;return 0}else if(q===m)return O(g,k);else if(q){if(!m)return 1}else return-1;for(;y;){o.unshift(y);y=y.parentNode}for(y=m;y;){s.unshift(y);y=y.parentNode}q=o.length;m=s.length;for(y=0;y<q&&y<m;y++)if(o[y]!==s[y])return O(o[y],s[y]);
return y===q?O(g,s[y],-1):O(o[y],k,1)};O=function(g,k,q){if(g===k)return q;for(g=g.nextSibling;g;){if(g===k)return-1;g=g.nextSibling}return 1}}l.getText=function(g){for(var k="",q,m=0;g[m];m++){q=g[m];if(q.nodeType===3||q.nodeType===4)k+=q.nodeValue;else if(q.nodeType!==8)k+=l.getText(q.childNodes)}return k};(function(){var g=w.createElement("div"),k="script"+(new Date).getTime(),q=w.documentElement;g.innerHTML="<a name='"+k+"'/>";q.insertBefore(g,q.firstChild);if(w.getElementById(k)){t.find.ID=function(m,
o,s){if(typeof o.getElementById!=="undefined"&&!s)return(o=o.getElementById(m[1]))?o.id===m[1]||typeof o.getAttributeNode!=="undefined"&&o.getAttributeNode("id").nodeValue===m[1]?[o]:z:[]};t.filter.ID=function(m,o){var s=typeof m.getAttributeNode!=="undefined"&&m.getAttributeNode("id");return m.nodeType===1&&s&&s.nodeValue===o}}q.removeChild(g);q=g=null})();(function(){var g=w.createElement("div");g.appendChild(w.createComment(""));if(g.getElementsByTagName("*").length>0)t.find.TAG=function(k,q){var m=
q.getElementsByTagName(k[1]);if(k[1]==="*"){for(var o=[],s=0;m[s];s++)m[s].nodeType===1&&o.push(m[s]);m=o}return m};g.innerHTML="<a href='#'></a>";if(g.firstChild&&typeof g.firstChild.getAttribute!=="undefined"&&g.firstChild.getAttribute("href")!=="#")t.attrHandle.href=function(k){return k.getAttribute("href",2)};g=null})();w.querySelectorAll&&function(){var g=l,k=w.createElement("div");k.innerHTML="<p class='TEST'></p>";if(!(k.querySelectorAll&&k.querySelectorAll(".TEST").length===0)){l=function(m,
o,s,y){o=o||w;if(!y&&!l.isXML(o)){var x=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(m);if(x&&(o.nodeType===1||o.nodeType===9))if(x[1])return G(o.getElementsByTagName(m),s);else if(x[2]&&t.find.CLASS&&o.getElementsByClassName)return G(o.getElementsByClassName(x[2]),s);if(o.nodeType===9){if(m==="body"&&o.body)return G([o.body],s);else if(x&&x[3]){var E=o.getElementById(x[3]);if(E&&E.parentNode){if(E.id===x[3])return G([E],s)}else return G([],s)}try{return G(o.querySelectorAll(m),s)}catch(P){}}else if(o.nodeType===
1&&o.nodeName.toLowerCase()!=="object"){x=o;var N=(E=o.getAttribute("id"))||"__sizzle__",L=o.parentNode,i=/^\s*[+~]/.test(m);if(E)N=N.replace(/'/g,"\\$&");else o.setAttribute("id",N);if(i&&L)o=o.parentNode;try{if(!i||L)return G(o.querySelectorAll("[id='"+N+"'] "+m),s)}catch(r){}finally{E||x.removeAttribute("id")}}}return g(m,o,s,y)};for(var q in g)l[q]=g[q];k=null}}();(function(){var g=w.documentElement,k=g.matchesSelector||g.mozMatchesSelector||g.webkitMatchesSelector||g.msMatchesSelector,q=false;
try{k.call(w.documentElement,"[test!='']:sizzle")}catch(m){q=true}if(k)l.matchesSelector=function(o,s){s=s.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!l.isXML(o))try{if(q||!t.match.PSEUDO.test(s)&&!/!=/.test(s))return k.call(o,s)}catch(y){}return l(s,null,null,[o]).length>0}})();(function(){var g=w.createElement("div");g.innerHTML="<div class='test e'></div><div class='test'></div>";if(!(!g.getElementsByClassName||g.getElementsByClassName("e").length===0)){g.lastChild.className="e";if(g.getElementsByClassName("e").length!==
1){t.order.splice(1,0,"CLASS");t.find.CLASS=function(k,q,m){if(typeof q.getElementsByClassName!=="undefined"&&!m)return q.getElementsByClassName(k[1])};g=null}}})();l.contains=w.documentElement.contains?function(g,k){return g!==k&&(g.contains?g.contains(k):true)}:w.documentElement.compareDocumentPosition?function(g,k){return!!(g.compareDocumentPosition(k)&16)}:function(){return false};l.isXML=function(g){return(g=(g?g.ownerDocument||g:0).documentElement)?g.nodeName!=="HTML":false};var S=function(g,
k){for(var q,m=[],o="",s=k.nodeType?[k]:k;q=t.match.PSEUDO.exec(g);){o+=q[0];g=g.replace(t.match.PSEUDO,"")}g=t.relative[g]?g+"*":g;q=0;for(var y=s.length;q<y;q++)l(g,s[q],m);return l.filter(o,m)};c.find=l;c.expr=l.selectors;c.expr[":"]=c.expr.filters;c.unique=l.uniqueSort;c.text=l.getText;c.isXMLDoc=l.isXML;c.contains=l.contains})();var sb=/Until$/,tb=/^(?:parents|prevUntil|prevAll)/,ub=/,/,fb=/^.[^:#\[\.,]*$/,vb=Array.prototype.slice,wb=c.expr.match.POS,xb={children:true,contents:true,next:true,
prev:true};c.fn.extend({find:function(a){for(var b=this.pushStack("","find",a),d=0,e=0,f=this.length;e<f;e++){d=b.length;c.find(a,this[e],b);if(e>0)for(var h=d;h<b.length;h++)for(var j=0;j<d;j++)if(b[j]===b[h]){b.splice(h--,1);break}}return b},has:function(a){var b=c(a);return this.filter(function(){for(var d=0,e=b.length;d<e;d++)if(c.contains(this,b[d]))return true})},not:function(a){return this.pushStack(Ba(this,a,false),"not",a)},filter:function(a){return this.pushStack(Ba(this,a,true),"filter",
a)},is:function(a){return!!a&&c.filter(a,this).length>0},closest:function(a,b){var d=[],e,f,h=this[0];if(c.isArray(a)){var j,p={},n=1;if(h&&a.length){e=0;for(f=a.length;e<f;e++){j=a[e];p[j]||(p[j]=c.expr.match.POS.test(j)?c(j,b||this.context):j)}for(;h&&h.ownerDocument&&h!==b;){for(j in p){e=p[j];if(e.jquery?e.index(h)>-1:c(h).is(e))d.push({selector:j,elem:h,level:n})}h=h.parentNode;n++}}return d}j=wb.test(a)?c(a,b||this.context):null;e=0;for(f=this.length;e<f;e++)for(h=this[e];h;)if(j?j.index(h)>
...
"</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]};R.optgroup=R.option;R.tbody=R.tfoot=R.colgroup=R.caption=R.thead;R.th=R.td;if(!c.support.htmlSerialize)R._default=[1,"div<div>","</div>"];c.fn.extend({text:function(a){if(c.isFunction(a))return this.each(function(b){var d=c(this);d.text(a.call(this,b,d.text()))});if(typeof a!=="object"&&a!==z)return this.empty().append((this[0]&&this[0].ownerDocument||w).createTextNode(a));
...
z)return this[0]&&this[0].nodeType===1?this[0].innerHTML.replace(yb,""):null;else if(typeof a==="string"&&!Sa.test(a)&&(c.support.leadingWhitespace||!xa.test(a))&&!R[(Ra.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(Qa,"<$1></$2>");try{for(var b=0,d=this.length;b<d;b++)if(this[b].nodeType===1){c.cleanData(this[b].getElementsByTagName("*"));this[b].innerHTML=a}}catch(e){this.empty().append(a)}}else c.isFunction(a)?this.each(function(f){var h=c(this);h.html(a.call(this,f,h.html()))}):this.empty().append(a);
return this},replaceWith:function(a){if(this[0]&&this[0].parentNode){if(c.isFunction(a))return this.each(function(b){var d=c(this),e=d.html();d.replaceWith(a.call(this,b,e))});if(typeof a!=="string")a=c(a).detach();return this.each(function(){var b=this.nextSibling,d=this.parentNode;c(this).remove();b?c(b).before(a):c(d).append(a)})}else return this.pushStack(c(c.isFunction(a)?a():a),"replaceWith",a)},detach:function(a){return this.remove(a,true)},domManip:function(a,b,d){var e,f,h,j=a[0],p=[];if(!c.support.checkClone&&
arguments.length===3&&typeof j==="string"&&Ta.test(j))return this.each(function(){c(this).domManip(a,b,d,true)});if(c.isFunction(j))return this.each(function(t){var A=c(this);a[0]=j.call(this,t,b?A.html():z);A.domManip(a,b,d)});if(this[0]){e=j&&j.parentNode;e=c.support.parentNode&&e&&e.nodeType===11&&e.childNodes.length===this.length?{fragment:e}:c.buildFragment(a,this,p);h=e.fragment;if(f=h.childNodes.length===1?h=h.firstChild:h.firstChild){b=b&&c.nodeName(f,"tr");f=0;for(var n=this.length,l=n-1;f<
n;f++)d.call(b?c.nodeName(this[f],"table")?this[f].getElementsByTagName("tbody")[0]||this[f].appendChild(this[f].ownerDocument.createElement("tbody")):this[f]:this[f],e.cacheable||n>1&&f<l?c.clone(h,true,true):h)}p.length&&c.each(p,gb)}return this}});c.buildFragment=function(a,b,d){var e,f,h;b=b&&b[0]?b[0].ownerDocument||b[0]:w;if(a.length===1&&typeof a[0]==="string"&&a[0].length<512&&b===w&&a[0].charAt(0)==="<"&&!Sa.test(a[0])&&(c.support.checkClone||!Ta.test(a[0]))){f=true;if(h=c.fragments[a[0]])if(h!==
1)e=h}if(!e){e=b.createDocumentFragment();c.clean(a,b,e,d)}if(f)c.fragments[a[0]]=h?e:1;return{fragment:e,cacheable:f}};c.fragments={};c.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){c.fn[a]=function(d){var e=[];d=c(d);var f=this.length===1&&this[0].parentNode;if(f&&f.nodeType===11&&f.childNodes.length===1&&d.length===1){d[b](this[0]);return this}else{f=0;for(var h=d.length;f<h;f++){var j=(f>0?this.clone(true):this).get();
c(d[f])[b](j);e=e.concat(j)}return this.pushStack(e,a,d.selector)}}});c.extend({clone:function(a,b,d){var e=a.cloneNode(true),f,h,j;if((!c.support.noCloneEvent||!c.support.noCloneChecked)&&(a.nodeType===1||a.nodeType===11)&&!c.isXMLDoc(a)){Da(a,e);f=ka(a);h=ka(e);for(j=0;f[j];++j)Da(f[j],h[j])}if(b){Ca(a,e);if(d){f=ka(a);h=ka(e);for(j=0;f[j];++j)Ca(f[j],h[j])}}return e},clean:function(a,b,d,e){b=b||w;if(typeof b.createElement==="undefined")b=b.ownerDocument||b[0]&&b[0].ownerDocument||w;for(var f=
[],h=0,j;(j=a[h])!=null;h++){if(typeof j==="number")j+="";if(j){if(typeof j==="string"&&!Ab.test(j))j=b.createTextNode(j);else if(typeof j==="string"){j=j.replace(Qa,"<$1></$2>");var p=(Ra.exec(j)||["",""])[1].toLowerCase(),n=R[p]||R._default,l=n[0],t=b.createElement("div");for(t.innerHTML=n[1]+j+n[2];l--;)t=t.lastChild;if(!c.support.tbody){l=zb.test(j);p=p==="table"&&!l?t.firstChild&&t.firstChild.childNodes:n[1]==="<table>"&&!l?t.childNodes:[];for(n=p.length-1;n>=0;--n)c.nodeName(p[n],"tbody")&&
!p[n].childNodes.length&&p[n].parentNode.removeChild(p[n])}!c.support.leadingWhitespace&&xa.test(j)&&t.insertBefore(b.createTextNode(xa.exec(j)[0]),t.firstChild);j=t.childNodes}if(j.nodeType)f.push(j);else f=c.merge(f,j)}}if(d)for(h=0;f[h];h++)if(e&&c.nodeName(f[h],"script")&&(!f[h].type||f[h].type.toLowerCase()==="text/javascript"))e.push(f[h].parentNode?f[h].parentNode.removeChild(f[h]):f[h]);else{f[h].nodeType===1&&f.splice.apply(f,[h+1,0].concat(c.makeArray(f[h].getElementsByTagName("script"))));
d.appendChild(f[h])}return f},cleanData:function(a){for(var b,d,e=c.cache,f=c.expando,h=c.event.special,j=c.support.deleteExpando,p=0,n;(n=a[p])!=null;p++)if(!(n.nodeName&&c.noData[n.nodeName.toLowerCase()]))if(d=n[c.expando]){if((b=e[d]&&e[d][f])&&b.events){for(var l in b.events)h[l]?c.event.remove(n,l):c.removeEvent(n,l,b.handle);if(b.handle)b.handle.elem=null}if(j)delete n[c.expando];else n.removeAttribute&&n.removeAttribute(c.expando);delete e[d]}}});var Ua=/alpha\([^)]*\)/i,Bb=/opacity=([^)]*)/,
Cb=/-([a-z])/ig,Db=/([A-Z])/g,Va=/^-?\d+(?:px)?$/i,Eb=/^-?\d/,Fb={position:"absolute",visibility:"hidden",display:"block"},hb=["Left","Right"],ib=["Top","Bottom"],ga,W,na,Gb=function(a,b){return b.toUpperCase()};c.fn.css=function(a,b){if(arguments.length===2&&b===z)return this;return c.access(this,a,b,true,function(d,e,f){return f!==z?c.style(d,e,f):c.css(d,e)})};c.extend({cssHooks:{opacity:{get:function(a,b){if(b){var d=ga(a,"opacity","opacity");return d===""?"1":d}else return a.style.opacity}}},
cssNumber:{zIndex:true,fontWeight:true,opacity:true,zoom:true,lineHeight:true},cssProps:{"float":c.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,b,d,e){if(!(!a||a.nodeType===3||a.nodeType===8||!a.style)){var f,h=c.camelCase(b),j=a.style,p=c.cssHooks[h];b=c.cssProps[h]||h;if(d!==z){if(!(typeof d==="number"&&isNaN(d)||d==null)){if(typeof d==="number"&&!c.cssNumber[h])d+="px";if(!p||!("set"in p)||(d=p.set(a,d))!==z)try{j[b]=d}catch(n){}}}else{if(p&&"get"in p&&(f=p.get(a,false,e))!==z)return f;
return j[b]}}},css:function(a,b,d){var e,f=c.camelCase(b),h=c.cssHooks[f];b=c.cssProps[f]||f;if(h&&"get"in h&&(e=h.get(a,true,d))!==z)return e;else if(ga)return ga(a,b,f)},swap:function(a,b,d){var e={},f;for(f in b){e[f]=a.style[f];a.style[f]=b[f]}d.call(a);for(f in b)a.style[f]=e[f]},camelCase:function(a){return a.replace(Cb,Gb)}});c.curCSS=c.css;c.each(["height","width"],function(a,b){c.cssHooks[b]={get:function(d,e,f){var h;if(e){if(d.offsetWidth!==0)h=Ea(d,b,f);else c.swap(d,Fb,function(){h=Ea(d,
b,f)});if(h<=0){h=ga(d,b,b);if(h==="0px"&&na)h=na(d,b,b);if(h!=null)return h===""||h==="auto"?"0px":h}if(h<0||h==null){h=d.style[b];return h===""||h==="auto"?"0px":h}return typeof h==="string"?h:h+"px"}},set:function(d,e){if(Va.test(e)){e=parseFloat(e);if(e>=0)return e+"px"}else return e}}});if(!c.support.opacity)c.cssHooks.opacity={get:function(a,b){return Bb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var d=a.style;
d.zoom=1;var e=c.isNaN(b)?"":"alpha(opacity="+b*100+")",f=d.filter||"";d.filter=Ua.test(f)?f.replace(Ua,e):d.filter+" "+e}};if(w.defaultView&&w.defaultView.getComputedStyle)W=function(a,b,d){var e;d=d.replace(Db,"-$1").toLowerCase();if(!(b=a.ownerDocument.defaultView))return z;if(b=b.getComputedStyle(a,null)){e=b.getPropertyValue(d);if(e===""&&!c.contains(a.ownerDocument.documentElement,a))e=c.style(a,d)}return e};if(w.documentElement.currentStyle)na=function(a,b){var d,e=a.currentStyle&&a.currentStyle[b],
f=a.runtimeStyle&&a.runtimeStyle[b],h=a.style;if(!Va.test(e)&&Eb.test(e)){d=h.left;if(f)a.runtimeStyle.left=a.currentStyle.left;h.left=b==="fontSize"?"1em":e||0;e=h.pixelLeft+"px";h.left=d;if(f)a.runtimeStyle.left=f}return e===""?"auto":e};ga=W||na;if(c.expr&&c.expr.filters){c.expr.filters.hidden=function(a){var b=a.offsetHeight;return a.offsetWidth===0&&b===0||!c.support.reliableHiddenOffsets&&(a.style.display||c.css(a,"display"))==="none"};c.expr.filters.visible=function(a){return!c.expr.filters.hidden(a)}}var Hb=
/%20/g,jb=/\[\]$/,Wa=/\r?\n/g,Ib=/#.*$/,Jb=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,Kb=/^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,Lb=/^(?:GET|HEAD)$/,Mb=/^\/\//,Xa=/\?/,Nb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,Ob=/^(?:select|textarea)/i,Ga=/\s+/,Pb=/([?&])_=[^&]*/,Qb=/(^|\-)([a-z])/g,Rb=function(a,b,d){return b+d.toUpperCase()},Ya=/^([\w\+\.\-]+:)\/\/([^\/?#:]*)(?::(\d+))?/,Za=c.fn.load,ra={},$a={},X,Y;try{X=w.location.href}catch(Yb){X=
w.createElement("a");X.href="";X=X.href}Y=Ya.exec(X.toLowerCase());c.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Za)return Za.apply(this,arguments);else if(!this.length)return this;var e=a.indexOf(" ");if(e>=0){var f=a.slice(e,a.length);a=a.slice(0,e)}e="GET";if(b)if(c.isFunction(b)){d=b;b=z}else if(typeof b==="object"){b=c.param(b,c.ajaxSettings.traditional);e="POST"}var h=this;c.ajax({url:a,type:e,dataType:"html",data:b,complete:function(j,p,n){n=j.responseText;if(j.isResolved()){j.done(function(l){n=
...
a,c.ajaxSettings,b);else{b=a;a=c.extend(true,c.ajaxSettings,b)}for(var d in{context:1,url:1})if(d in b)a[d]=b[d];else if(d in c.ajaxSettings)a[d]=c.ajaxSettings[d];return a},ajaxSettings:{url:X,isLocal:/(?:^file|^widget|\-extension):$/.test(Y[1]),global:true,type:"GET",contentType:"application/x-www-form-urlencoded",processData:true,async:true,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":"*/*"},contents:{xml:/xml/,html:/html/,
json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":I.String,"text html":true,"text json":c.parseJSON,"text xml":c.parseXML}},ajaxPrefilter:Fa(ra),ajaxTransport:Fa($a),ajax:function(a,b){function d(m,o,s,y){if(J!==2){J=2;G&&clearTimeout(G);D=z;A=y||"";g.readyState=m?4:0;var x,E,P;if(s){y=e;var N=g,L=y.contents,i=y.dataTypes,r=y.responseFields,u,v,B,C;for(v in r)if(v in s)N[r[v]]=s[v];for(;i[0]==="*";){i.shift();if(u===z)u=y.mimeType||N.getResponseHeader("content-type")}if(u)for(v in L)if(L[v]&&
L[v].test(u)){i.unshift(v);break}if(i[0]in s)B=i[0];else{for(v in s){if(!i[0]||y.converters[v+" "+i[0]]){B=v;break}C||(C=v)}B=B||C}if(B){B!==i[0]&&i.unshift(B);s=s[B]}else s=void 0}else s=z;if(m>=200&&m<300||m===304){if(e.ifModified){if(u=g.getResponseHeader("Last-Modified"))c.lastModified[l]=u;if(u=g.getResponseHeader("Etag"))c.etag[l]=u}if(m===304){o="notmodified";x=true}else try{u=e;if(u.dataFilter)s=u.dataFilter(s,u.dataType);var H=u.dataTypes;v={};var K,Q,ea=H.length,T,U=H[0],ca,ya,V,Z,da;for(K=
1;K<ea;K++){if(K===1)for(Q in u.converters)if(typeof Q==="string")v[Q.toLowerCase()]=u.converters[Q];ca=U;U=H[K];if(U==="*")U=ca;else if(ca!=="*"&&ca!==U){ya=ca+" "+U;V=v[ya]||v["* "+U];if(!V){da=z;for(Z in v){T=Z.split(" ");if(T[0]===ca||T[0]==="*")if(da=v[T[1]+" "+U]){Z=v[Z];if(Z===true)V=da;else if(da===true)V=Z;break}}}V||da||c.error("No conversion from "+ya.replace(" "," to "));if(V!==true)s=V?V(s):da(Z(s))}}E=s;o="success";x=true}catch(Sb){o="parsererror";P=Sb}}else{P=o;if(!o||m){o="error";
if(m<0)m=0}}g.status=m;g.statusText=o;x?j.resolveWith(f,[E,o,g]):j.rejectWith(f,[g,o,P]);g.statusCode(n);n=z;if(O)h.trigger("ajax"+(x?"Success":"Error"),[g,e,x?E:P]);p.resolveWith(f,[g,o]);if(O){h.trigger("ajaxComplete",[g,e]);--c.active||c.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=z}b=b||{};var e=c.ajaxSetup({},b),f=e.context||e,h=f!==e&&(f.nodeType||f instanceof c)?c(f):c.event,j=c.Deferred(),p=c._Deferred(),n=e.statusCode||{},l,t={},A,F,D,G,M,J=0,O,S,g={readyState:0,setRequestHeader:function(m,
o){J||(t[m.toLowerCase().replace(Qb,Rb)]=o);return this},getAllResponseHeaders:function(){return J===2?A:null},getResponseHeader:function(m){var o;if(J===2){if(!F)for(F={};o=Jb.exec(A);)F[o[1].toLowerCase()]=o[2];o=F[m.toLowerCase()]}return o===z?null:o},overrideMimeType:function(m){if(!J)e.mimeType=m;return this},abort:function(m){m=m||"abort";D&&D.abort(m);d(0,m);return this}};j.promise(g);g.success=g.done;g.error=g.fail;g.complete=p.done;g.statusCode=function(m){if(m){var o;if(J<2)for(o in m)n[o]=
[n[o],m[o]];else{o=m[g.status];g.then(o,o)}}return this};e.url=((a||e.url)+"").replace(Ib,"").replace(Mb,Y[1]+"//");e.dataTypes=c.trim(e.dataType||"*").toLowerCase().split(Ga);if(!e.crossDomain){M=Ya.exec(e.url.toLowerCase());e.crossDomain=!!(M&&(M[1]!=Y[1]||M[2]!=Y[2]||(M[3]||(M[1]==="http:"?80:443))!=(Y[3]||(Y[1]==="http:"?80:443))))}if(e.data&&e.processData&&typeof e.data!=="string")e.data=c.param(e.data,e.traditional);la(ra,e,b,g);if(J===2)return false;O=e.global;e.type=e.type.toUpperCase();e.hasContent=
!Lb.test(e.type);O&&c.active++===0&&c.event.trigger("ajaxStart");if(!e.hasContent){if(e.data)e.url+=(Xa.test(e.url)?"&":"?")+e.data;l=e.url;if(e.cache===false){M=c.now();var k=e.url.replace(Pb,"$1_="+M);e.url=k+(k===e.url?(Xa.test(e.url)?"&":"?")+"_="+M:"")}}if(e.data&&e.hasContent&&e.contentType!==false||b.contentType)t["Content-Type"]=e.contentType;if(e.ifModified){l=l||e.url;if(c.lastModified[l])t["If-Modified-Since"]=c.lastModified[l];if(c.etag[l])t["If-None-Match"]=c.etag[l]}t.Accept=e.dataTypes[0]&&
e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+(e.dataTypes[0]!=="*"?", */*; q=0.01":""):e.accepts["*"];for(S in e.headers)g.setRequestHeader(S,e.headers[S]);if(e.beforeSend&&(e.beforeSend.call(f,g,e)===false||J===2)){g.abort();return false}for(S in{success:1,error:1,complete:1})g[S](e[S]);if(D=la($a,e,b,g)){g.readyState=1;O&&h.trigger("ajaxSend",[g,e]);if(e.async&&e.timeout>0)G=setTimeout(function(){g.abort("timeout")},e.timeout);try{J=1;D.send(t,d)}catch(q){status<2?d(-1,q):c.error(q)}}else d(-1,
"No Transport");return g},param:function(a,b){var d=[],e=function(h,j){j=c.isFunction(j)?j():j;d[d.length]=encodeURIComponent(h)+"="+encodeURIComponent(j)};if(b===z)b=c.ajaxSettings.traditional;if(c.isArray(a)||a.jquery&&!c.isPlainObject(a))c.each(a,function(){e(this.name,this.value)});else for(var f in a)sa(f,a[f],b,e);return d.join("&").replace(Hb,"+")}});c.extend({active:0,lastModified:{},etag:{}});var Tb=c.now(),oa=/(\=)\?(&|$)|()\?\?()/i;c.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return c.expando+
"_"+Tb++}});c.ajaxPrefilter("json jsonp",function(a,b,d){var e=typeof a.data==="string";if(a.dataTypes[0]==="jsonp"||b.jsonpCallback||b.jsonp!=null||a.jsonp!==false&&(oa.test(a.url)||e&&oa.test(a.data))){var f,h=a.jsonpCallback=c.isFunction(a.jsonpCallback)?a.jsonpCallback():a.jsonpCallback,j=I[h];b=a.url;var p=a.data,n="$1"+h+"$2",l=function(){I[h]=j;if(f&&c.isFunction(j))I[h](f[0])};if(a.jsonp!==false){b=b.replace(oa,n);if(a.url===b){if(e)p=p.replace(oa,n);if(a.data===p)b+=(/\?/.test(b)?"&":"?")+
a.jsonp+"="+h}}a.url=b;a.data=p;I[h]=function(t){f=[t]};d.then(l,l);a.converters["script json"]=function(){f||c.error(h+" was not called");return f[0]};a.dataTypes[0]="json";return"script"}});c.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/javascript|ecmascript/},converters:{"text script":function(a){c.globalEval(a);return a}}});c.ajaxPrefilter("script",function(a){if(a.cache===z)a.cache=false;if(a.crossDomain){a.type=
"GET";a.global=false}});c.ajaxTransport("script",function(a){if(a.crossDomain){var b,d=w.head||w.getElementsByTagName("head")[0]||w.documentElement;return{send:function(e,f){b=w.createElement("script");b.async="async";if(a.scriptCharset)b.charset=a.scriptCharset;b.src=a.url;b.onload=b.onreadystatechange=function(h,j){if(!b.readyState||/loaded|complete/.test(b.readyState)){b.onload=b.onreadystatechange=null;d&&b.parentNode&&d.removeChild(b);b=z;j||f(200,"success")}};d.insertBefore(b,d.firstChild)},
abort:function(){if(b)b.onload(0,1)}}}});var Ub=c.now(),aa;c.ajaxSettings.xhr=I.ActiveXObject?function(){var a;if(!(a=!this.isLocal&&Ha()))a:{try{a=new I.ActiveXObject("Microsoft.XMLHTTP");break a}catch(b){}a=void 0}return a}:Ha;W=c.ajaxSettings.xhr();c.support.ajax=!!W;c.support.cors=W&&"withCredentials"in W;W=z;c.support.ajax&&c.ajaxTransport(function(a){if(!a.crossDomain||c.support.cors){var b;return{send:function(d,e){var f=a.xhr(),h,j;a.username?f.open(a.type,a.url,a.async,a.username,a.password):
f.open(a.type,a.url,a.async);if(a.xhrFields)for(j in a.xhrFields)f[j]=a.xhrFields[j];a.mimeType&&f.overrideMimeType&&f.overrideMimeType(a.mimeType);if(!(a.crossDomain&&!a.hasContent)&&!d["X-Requested-With"])d["X-Requested-With"]="XMLHttpRequest";try{for(j in d)f.setRequestHeader(j,d[j])}catch(p){}f.send(a.hasContent&&a.data||null);b=function(n,l){var t,A,F,D,G;try{if(b&&(l||f.readyState===4)){b=z;if(h){f.onreadystatechange=c.noop;delete aa[h]}if(l)f.readyState!==4&&f.abort();else{t=f.status;F=f.getAllResponseHeaders();
D={};if((G=f.responseXML)&&G.documentElement)D.xml=G;D.text=f.responseText;try{A=f.statusText}catch(M){A=""}if(!t&&a.isLocal&&!a.crossDomain)t=D.text?200:404;else if(t===1223)t=204}}}catch(J){l||e(-1,J)}D&&e(t,A,D,F)};if(!a.async||f.readyState===4)b();else{if(!aa){aa={};kb()}h=Ub++;f.onreadystatechange=aa[h]=b}},abort:function(){b&&b(0,1)}}}});var ta={},Vb=/^(?:toggle|show|hide)$/,Wb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,pa,Ia=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width",
"marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]];c.fn.extend({show:function(a,b,d){if(a||a===0)return this.animate(ba("show",3),a,b,d);else{d=0;for(var e=this.length;d<e;d++){a=this[d];b=a.style.display;if(!c._data(a,"olddisplay")&&b==="none")b=a.style.display="";b===""&&c.css(a,"display")==="none"&&c._data(a,"olddisplay",Ja(a.nodeName))}for(d=0;d<e;d++){a=this[d];b=a.style.display;if(b===""||b==="none")a.style.display=c._data(a,"olddisplay")||""}return this}},hide:function(a,
b,d){if(a||a===0)return this.animate(ba("hide",3),a,b,d);else{a=0;for(b=this.length;a<b;a++){d=c.css(this[a],"display");d!=="none"&&!c._data(this[a],"olddisplay")&&c._data(this[a],"olddisplay",d)}for(a=0;a<b;a++)this[a].style.display="none";return this}},_toggle:c.fn.toggle,toggle:function(a,b,d){var e=typeof a==="boolean";if(c.isFunction(a)&&c.isFunction(b))this._toggle.apply(this,arguments);else a==null||e?this.each(function(){var f=e?a:c(this).is(":hidden");c(this)[f?"show":"hide"]()}):this.animate(ba("toggle",
...
if(p&&(j==="height"||j==="width")){h.overflow=[this.style.overflow,this.style.overflowX,this.style.overflowY];if(c.css(this,"display")==="inline"&&c.css(this,"float")==="none")if(c.support.inlineBlockNeedsLayout)if(Ja(this.nodeName)==="inline")this.style.display="inline-block";else{this.style.display="inline";this.style.zoom=1}else this.style.display="inline-block"}if(c.isArray(a[j])){(h.specialEasing=h.specialEasing||{})[j]=a[j][1];a[j]=a[j][0]}}if(h.overflow!=null)this.style.overflow="hidden";h.curAnim=
c.extend({},a);c.each(a,function(A,F){var D=new c.fx(l,h,A);if(Vb.test(F))D[F==="toggle"?n?"show":"hide":F](a);else{var G=Wb.exec(F),M=D.cur();if(G){var J=parseFloat(G[2]),O=G[3]||(c.cssNumber[A]?"":"px");if(O!=="px"){c.style(l,A,(J||1)+O);M*=(J||1)/D.cur();c.style(l,A,M+O)}if(G[1])J=(G[1]==="-="?-1:1)*J+M;D.custom(M,J,O)}else D.custom(M,F,"")}});return true})},stop:function(a,b){var d=c.timers;a&&this.queue([]);this.each(function(){for(var e=d.length-1;e>=0;e--)if(d[e].elem===this){if(b)d[e](true);
...
"opacity",a.now)},_default:function(a){if(a.elem.style&&a.elem.style[a.prop]!=null)a.elem.style[a.prop]=(a.prop==="width"||a.prop==="height"?Math.max(0,a.now):a.now)+a.unit;else a.elem[a.prop]=a.now}}});if(c.expr&&c.expr.filters)c.expr.filters.animated=function(a){return c.grep(c.timers,function(b){return a===b.elem}).length};var Xb=/^t(?:able|d|h)$/i,ab=/^(?:body|html)$/i;c.fn.offset="getBoundingClientRect"in w.documentElement?function(a){var b=this[0],d;if(a)return this.each(function(j){c.offset.setOffset(this,
...
this[0];if(a)return this.each(function(l){c.offset.setOffset(this,a,l)});if(!b||!b.ownerDocument)return null;if(b===b.ownerDocument.body)return c.offset.bodyOffset(b);c.offset.initialize();var d,e=b.offsetParent,f=b.ownerDocument,h=f.documentElement,j=f.body;d=(f=f.defaultView)?f.getComputedStyle(b,null):b.currentStyle;for(var p=b.offsetTop,n=b.offsetLeft;(b=b.parentNode)&&b!==j&&b!==h;){if(c.offset.supportsFixedPosition&&d.position==="fixed")break;d=f?f.getComputedStyle(b,null):b.currentStyle;p-=
b.scrollTop;n-=b.scrollLeft;if(b===e){p+=b.offsetTop;n+=b.offsetLeft;if(c.offset.doesNotAddBorder&&!(c.offset.doesAddBorderForTableAndCells&&Xb.test(b.nodeName))){p+=parseFloat(d.borderTopWidth)||0;n+=parseFloat(d.borderLeftWidth)||0}e=b.offsetParent}if(c.offset.subtractsBorderForOverflowNotVisible&&d.overflow!=="visible"){p+=parseFloat(d.borderTopWidth)||0;n+=parseFloat(d.borderLeftWidth)||0}}if(d.position==="relative"||d.position==="static"){p+=j.offsetTop;n+=j.offsetLeft}if(c.offset.supportsFixedPosition&&
d.position==="fixed"){p+=Math.max(h.scrollTop,j.scrollTop);n+=Math.max(h.scrollLeft,j.scrollLeft)}return{top:p,left:n}};c.offset={initialize:function(){var a=w.body,b=w.createElement("div"),d,e,f,h=parseFloat(c.css(a,"marginTop"))||0;c.extend(b.style,{position:"absolute",top:0,left:0,margin:0,border:0,width:"1px",height:"1px",visibility:"hidden"});b.innerHTML="<div style='position:absolute;top:0;left:0;margin:0;border:5px solid #000;padding:0;width:1px;height:1px;'><div></div></div><table style='position:absolute;top:0;left:0;margin:0;border:5px solid #000;padding:0;width:1px;height:1px;' cellpadding='0' cellspacing='0'><tr><td></td></tr></table>";

            ...
            try {
                if (db && db.available) {
                    if (confirm("Overwrite current backup?")) {
                        profiles.backup("current", function (event) {
            ...
            try {
                if (db && db.available) {
                    if (confirm("Restore current backup?")) {
                        profiles.restore("current", function (event) {
